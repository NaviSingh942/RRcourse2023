...
library(metafor)
library(dplyr)
#setwd("C:/Users/ns352220/Desktop/13. Metaanalysis")
```
...
```{r}
data <- read_excel("C:/Users/ns352220/Desktop/13. Metaanalysis/data/metaanalysis_data.xlsx")
```
...
meta_male_toys <- metacont(n.e=N_girls,
                          mean.e=Mean_girls_play_male,
                          sd.e=SD_girls_play_male,
                          n.c=N_boys,
...
meta_female_toys <- metacont(n.e=N_boys,
